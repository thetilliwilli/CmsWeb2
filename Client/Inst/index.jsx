...
export default class Inst extends React.Component
{
    ...
    render(){
        // const appid = this.props.instList[this.state.selected].id;
        return (
            <div style={{height:"100%", width:"100%", display:"flex", flexWrap:"wrap"}} >
                ...
                <div style={{width:"82%", height:"100%"}} >
                    <InstEditor fields={this.props.instList[this.state.selected]} OnSave={()=>alert("Saved")} OnDelete={()=>alert("Deleted")}/>
                </div>
            </div>
        );
    }
