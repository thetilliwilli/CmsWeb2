...
export default function ControlPanel(props){
    ...
    const buttonBar = props.isEditMode
        ? <div style={containerStyle}>
            <RaisedButton label="СОХРАНИТЬ" style={buttonStyle} onClick={props.handlers.OnSubmitExhibitUpdate}></RaisedButton>
            <RaisedButton label="СОЗДАТЬ НОВЫЙ" style={buttonStyle} onClick={props.handlers.OnSubmitNewExhibit}></RaisedButton>
        ...
        : <div style={containerStyle}>
            <RaisedButton label="ЗАГРУЗИТЬ В БАЗУ" style={buttonStyle} onClick={props.handlers.OnSubmitNewExhibit}></RaisedButton>
