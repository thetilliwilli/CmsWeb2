...
export default function ControlPanel(props){
    const buttonBar = props.isEditMode
        ? <div style={{padding:"4px 4px 4px 4px"}}>
            <RaisedButton label="СОХРАНИТЬ" style={{marginLeft:"10px"}} onClick={props.handlers.OnSubmitDesignerUpdate}></RaisedButton>
            <RaisedButton label="СОЗДАТЬ НОВЫЙ" style={{marginLeft:"10px"}} onClick={props.handlers.OnSubmitNewDesigner}></RaisedButton>
        ...
        : <div style={{padding:"4px 4px 4px 4px"}}>
            <RaisedButton label="ЗАГРУЗИТЬ В БАЗУ" style={{marginLeft:"10px"}} onClick={props.handlers.OnSubmitNewDesigner}></RaisedButton>
