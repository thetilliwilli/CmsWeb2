...
import {DesignerChangeCountries} from "../App/designerAc.js";
const S2P = state => ({
    countriesListCreate: state.designerDomain.designerCreate.data.countries,
    countriesListEdit: state.designerDomain.designerEdit.data.countries,
});
const D2P = dsp => ({
    ChangeCountries: (mode, countries) => dsp(DesignerChangeCountries(mode, countries)),
});
